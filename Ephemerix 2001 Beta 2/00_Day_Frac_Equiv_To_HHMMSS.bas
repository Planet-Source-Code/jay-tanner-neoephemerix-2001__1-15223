Attribute VB_Name = "Day_Frac_Equiv_To_HHMMSS"
  Option Explicit

' ===================================================================

' Compute fraction of a day corresponding to a given time string in
' the format  ± HH:MM:SS

  Public Function Day_Frac_Equiv_To(HHMMSS)
' LEVEL 0
...
' Return the equivalent fraction of a day equivalent to time string
  Day_Frac_Equiv_To = Sign * S / 86400#
