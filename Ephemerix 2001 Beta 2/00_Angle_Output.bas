...
' several
' different units.  The angle can be an hour angle or any longitude
' or latitude  angle in general.
'
...
' DD  = Decimal degrees - Decimals = 7
' DMS = Degrees, Minutes and Seconds - Decimals = 1
' DH  = Decimal hours - Decimals = 7
' HMS = Hours, Minutes and Seconds - Decimals = 2
'
