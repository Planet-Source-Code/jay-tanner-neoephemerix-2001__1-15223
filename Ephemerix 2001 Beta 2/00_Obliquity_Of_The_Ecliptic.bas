Attribute VB_Name = "Obliquity_of_the_Ecliptic"
  Option Explicit
...
' is returned.  Only a single letter "M" or "A" is required.
  ...
  Public Function Ecliptic_Obliquity(At_JDE, Mean_or_Apparent)
' LEVEL 0
...
' If not apparent mode, then return mean value
  If M_or_A = "M" Then Ecliptic_Obliquity = Obl: Exit Function
...
' Return true apparent ecliptic obliquity in decimal degrees
  Ecliptic_Obliquity = Obl + Q / 36000000
